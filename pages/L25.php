...
<body>
   ...
   <div id="container">
      ...
      <div class="produit">
         <div class="gauche">
            <div class="titre">
               <h1>Liquide Ananas </h1> <!-- coller a droite -->
            </div>
            <div class="image">
               <img src='../image/produit/L25.jpg'>
            </div>
         </div>
         <div class="droite">
            <div class="description">
               <p> Flacon de 10ml contenant du liquide goût Ananas. Compatible avec tout les E-Cigarettes.
            ...
            <div class="bouton">
               <a href='L25.php?action=ajout&amp;i=L25&amp;l=Liquide Ananas&amp;q=1&amp;p=9€'>Ajouter au panier</a>
            </div>
         </div>
      </div>
