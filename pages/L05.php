...
<body>
   ...
   <div id="container">
      ...
      <div class="produit">
         <div class="gauche">
            <div class="titre">
               <h1>Liquide Pomme </h1> <!-- coller a droite -->
            </div>
            <div class="image">
               <img src='../image/produit/L05.jpg'>
            </div>
         </div>
         <div class="droite">
            <div class="description">
               <p> Flacon de 10ml goût Pomme. Compatible avec toutes les E-Cigarettes.
            ...
            <div class="bouton">
               <a href='L05.php?action=ajout&amp;i=L05&amp;l=Liquide Pomme&amp;q=1&amp;p=10€'>Ajouter au panier</a>
            </div>
         </div>
      </div>
