...
<body>
    ...
    <div id="container">
        ...
        <div class="produit"><div class="gauche">
            <div class="titre">
                <h1>Outil de demontage                                                                  </h1> <!-- coller a droite -->
            </div>
            <div class="image">
        <img src='../image/produit/A13.jpg'>                         </div></div>
            <div class="droite">
            <div class="description">
                <p> Set d'outil pour pouvoir entretenir sa Ecigarette sois meme                                                                                                               
            ...
            <div class="bouton">
              <a href='A13.php?action=ajout&amp;i=A13&amp;l=Outil de demontage&amp;q=1&amp;p=41€'>Ajouter au panier</a></div>                                                                     </div>
        </div>
